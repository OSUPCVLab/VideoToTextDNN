            ...
            for idx in self.engine.kf_train:
                ...
                if test:
                    ...
                    metrics.save_samples(
                        ...
                        beam=5, n_process=5,
                        whichset='blind', #for vtt change to test, for lsmdc to blind for competition
                        on_cpu=False,
        ...
        for eidx in xrange(max_epochs):
            ...
            for idx in self.engine.kf_train:
                ...
                if validFreq != -1 and numpy.mod(uidx, validFreq) == 0:
                    ...
                    current_params = unzip(tparams)
                    numpy.savez(os.path.join(save_model_dir,'model_current.npz'),
                    ...
                    if len(history_errs) > 1 and \
                        ...
                        numpy.savez(os.path.join(save_model_dir,'model_best_blue_or_meteor.npz'),
                    ...
                    if len(history_errs) > 1 and \
                        ...
                        print 'Saving to %s...'%save_model_dir,
                        numpy.savez(os.path.join(save_model_dir,'model_best_so_far.npz'),
                            history_errs=history_errs, **best_p)
                        with open(os.path.join(save_model_dir,'model_options.pkl'), 'wb') as f:
                            pkl.dump(model_options, f)
                        print 'Done'
